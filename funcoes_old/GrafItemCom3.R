...
GrafItemCom3 <- function(dirgrf,nomgrf,anos,gabitem,itcom1,param1,rj1,percpr1,itcom2,param2,rj2,percpr2,ger,geral){
  ...
  for (ig in 1:ng)  {
    ...
    points(xq[paste("V",1:40,sep='')],rj1[ip1,paste("V",1:40,sep='')],pch=1)
    points(xq[paste("V",1:40,sep='')],rj2[ip2,paste("V",1:40,sep='')],pch=16)
